...
const url = process.env.MONGOLAB_URI;       //env var para di makita yung pass

// RUN SCHEDULED UPDATES (EVERY 12 HRS)
const runup = schedule.scheduleJob("* */12 * * *", () =>
{
    const cp = childProcess.fork(path.join(__dirname, "dbupdates.js"));
    cp.on("exit", (code, signal) => {
        console.log("Updates Done!", {code: code, signal: signal});
    });
